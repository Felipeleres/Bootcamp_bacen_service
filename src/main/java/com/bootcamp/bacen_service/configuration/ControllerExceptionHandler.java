...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetail handlerChaveJaCadastrada(ChaveJaCadastradaException ex){
        ...
        problemDetail.setType(URI.create("Http://localhost/8080/document/chave-ja-cadastrada"));
    ...
    private ProblemDetail handlerChaveNaoLocalizada(ChaveNaoLocalizadaException ex){
        ...
        problemDetail.setType(URI.create("Http://localhost/8080/document/chave-nao-existe"));
        return problemDetail;
    }
